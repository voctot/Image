        ...
        <div class="archive-title" id="archives-<?php echo $groupedDate?>">
            <div class="archives" data-date="<?php echo $groupedDate?>">
                ...
                <?php foreach ($archives as $archive):?>
                    ...
                    $prefix = '';
                    $extClass = '';
                    if ($archive['status'] == 'hidden') {
                        $prefix = '<i class="fa fa-eye-slash" aria-hidden="true"></i> ';
                        $extClass = 'hidden';
                    } elseif ($archive['status'] == 'private') {
                        $prefix = '<i class="fa fa-lock" aria-hidden="true"></i> ';
                        $extClass = 'private';
                    }
                    ?>
                    <div class="brick <?php echo $extClass?>">
                        <a href="<?php echo $archive['permalink']?>">
                            <span class="time"><?php echo date('m-d', $archive['created'])?></span> <?php echo $prefix?><?php echo $archive['title']?>
                        </a>
                    </div>
                <?php endforeach;?>
            </div>
