...
<?php if(COMMENT_SYSTEM !== Mirages_Const::COMMENT_SYSTEM_DISQUS && NIGHT_SHIFT_BTN_CLASS == "auto-mode"):?>
    <script>
...
<?php endif?>
    ...
    <div id="body">
        ...
        <script type="text/javascript">
            ...
            <?php Content::detectBodyClassForPJAX('serif-fonts', 'body')?>
        ...
        <?php Mirages::$options->defaultBgHeight();?>;">
            ...
            <script type="text/javascript">
                ...
                <?php if(Mirages::$options->bannerCDNType <= 0 && Mirages::$options->noBannerImage__isFalse):?>
                    ...
                    var position = '<?php Mirages::$options->bannerPosition()?>';
            ...
            <div class="inner">
                <div class="container">
                    ...
                    <h2 class="blog-description <?php if ($this->is('post') || $this->is('page')) echo 'font-mono'?>" style="<?php if (Utils::hasValue($this->fields->mastheadTitleColor)) echo "color: ".$this->fields->mastheadTitleColor.";" ?>">
                        <?php
                        if (!($this->is('post') || $this->is('page'))) {
                            if ($this->is('category') && Mirages::$options->showBanner) {
