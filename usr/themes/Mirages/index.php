 ...
 * 一套简洁的，带自适应的主题
 *
 * 详细的安装及升级帮助可以查看: <a href="https://get233.com/archives/mirages-home.html">这里</a>
 *
 * 如果有什么意见或建议也欢迎到<a href="https://get233.com/mirages-feedback.html?theme_info&v=7102#comments">我的博客留言</a>
 *
 * @package Mirages
 * @author Hran
 * @version 7.10.2
 * @link http://get233.com/?mirages=7102
 */
	    ...
	    <?php while($this->next()): ?>
                ...
                <article itemscope itemtype="http://schema.org/BlogPosting" class="<?php echo Utils::isTrue($this->fields->disableDarkMask) ? 'no-mask':''?>">
                    ...
                    <a href="<?php $this->permalink() ?>">
                        ...
                        if (!Utils::hasValue($banner)) {
                            ...
                            $banner = Utils::replaceCDNOptimizeLink($position[0]);
            ...
            <?php else:?>
                <article itemscope itemtype="http://schema.org/BlogPosting">
                    ...
                    <meta itemprop="dateModified" content="<?php echo date('c' , $this->modified);?>">
                    <div class="post">
                        <a href="<?php $this->permalink() ?>"><h2 class="post-title" itemprop="headline"><?php $this->sticky();echo Mirages::parseBiaoqing($this->title);?></h2></a>
                        <div class="post-info">
                            <span itemprop="datePublished" content="<?php $this->date('c'); ?>"><?php $this->date(I18n::dateFormat()); ?> • </span>
                            <span><?php Content::category($this->categories)?> • </span>
